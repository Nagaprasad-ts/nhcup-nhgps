    ...
    <section className="relative overflow-hidden min-h-screen" style={{ background: '#FFF8EE' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 flex flex-col lg:flex-row items-center gap-10 min-h-screen py-10">
        ...
        <div className="flex-1 flex flex-col justify-center py-8 lg:py-0">
          ...
          {/* Heading */}
          <h1 className="font-black text-navy leading-[1] mb-4" style={{ fontSize: 'clamp(2.6rem,5vw,4rem)' }}>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200/70">
            ...
            <div className="grid grid-cols-2 gap-4 sm:hidden">
              {[
                { value: "June '26", label: 'Start Date', color: 'text-navy' },
                { value: '3–8 yrs',  label: 'Age Group',  color: 'text-navy' },
                { value: 'Mon–Sat',  label: 'Schedule',   color: 'text-navy' },
                { value: 'May 1',    label: 'Reg. Opens', color: 'text-coral' },
            ...
            <div className="hidden sm:flex items-center gap-5">
              <div className="text-center">
                <p className="text-navy font-black text-lg">June '26</p>
                <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">Start Date</p>
              </div>
              <div className="w-px h-8 bg-gray-200" />
              <div className="text-center">
                <p className="text-navy font-black text-lg">3–8 yrs</p>
              ...
              <div className="w-px h-8 bg-gray-200" />
              <div className="text-center">
                <p className="text-coral font-black text-lg">May 1</p>
        ...
        {/* ── RIGHT: Image ── */}
        <div className="relative flex-shrink-0 w-full lg:w-[420px] flex items-center justify-center pb-8 lg:pb-0">
