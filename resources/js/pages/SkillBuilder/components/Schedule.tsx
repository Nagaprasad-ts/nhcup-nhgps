...
export default function Schedule() {
  const cards: ScheduleCard[] = [
    ...
    },
    {
      ...
      title: 'June 2026 – March 2027',
      subtitle: 'Full Academic Year',
      desc: (
        <>Registration begins <span className="font-black text-coral">May 1, 2026</span>. Seats are limited — enrol early.</>
      ),
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-10 items-stretch">
        ...
        <div className="lg:w-[380px] flex-shrink-0 relative">
          <div className="lg:sticky lg:top-8">
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl w-full"
              ...
              <div className="absolute bottom-5 left-5 right-5">
                ...
                <p className="text-white/70 text-xs font-semibold">Mon – Sat · 1:30 PM onwards</p>
              </div>
            </div>
            {/* Badge */}
            <div className="absolute -top-3 -right-3 bg-[#FFE234] rounded-2xl px-4 py-2.5 shadow-lg"
              ...
              <p className="text-sm font-black text-navy">Age 3–8 ✦</p>
            </div>
          </div>
        </div>
